 ...
 */
public class QRBloomFilter<E> implements Serializable {
    ...
    static final String hashName = "SHA1";
     ...
     */
    public QRBloomFilter(double c, int n, int k) {
     ...
     */
    public QRBloomFilter(double falsePositiveProbability, int expectedNumberOfElements) {
        // c = k / ln(2)
    ...
    public void addAndCheckContains(E element) {
        if (!contains(element)) {
            add(element);
        }
    }
